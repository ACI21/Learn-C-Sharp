...
public class Ejercicio7
{
    public static void main()
    {
        ...
        if(numero1 < numero2 && numero1 < numero3){
            //el numero 1 es el más pequeño
            if(numero2 < numero3){
                //El numero 2 es el segundo más pequeño
                Console.WriteLine("Orden de menor a mayor: {0} < {1} < {2}",numero1,numero2,numero3);
            }else{
                //El numero 3 es el segundo más pequeño
                Console.WriteLine("Orden de menor a mayor: {0} < {1} < {2}",numero1,numero3,numero2);
            }
        }else if(numero2 < numero1 && numero2 < numero3){
            //el numero 2 es el más pequeño
            if(numero1 < numero3){
                //El numero 1 es el segundo más pequeño
