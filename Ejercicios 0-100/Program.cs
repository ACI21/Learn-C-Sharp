...
class Program
{
    static void Main(string[] args)
    {
        ...
        do
        {
            ...
            Console.WriteLine("*       14 -> Ejercicio numero secreto    *");
            Console.WriteLine("*       15 -> Ejercicio 1 --> X           *");
            Console.WriteLine("*       16 -> Ejercicio Tabla multiplicar *");
            Console.WriteLine("*       17 -> Ejercicio Tablas 1-10       *");
